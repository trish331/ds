...
void setup () {
  ...
  SkeletonUp = new AnimatedGIF (4, 10, "Skeleton/_up/Skeleton_", ".png");
  SkeletonDown = new AnimatedGIF (4, 10, "Skeleton/_down/Skeleton_", ".png");
  SkeletonLeft = new AnimatedGIF (4, 10, "Skeleton/_left/Skeleton_", ".png");
  SkeletonRight = new AnimatedGIF (4, 10, "Skeleton/_right/Skeleton_", ".png");
  //create darkness
